<template>
    <div class="row">
        <div class="col-md-12">
            <SortedTable :values="this.computed_items" class="table table-striped">
                <thead>
                    <tr>
...
<script>
    ...
    export default {
        ...
        computed: {
                computed_items(){
                    ...
                    return this.transactions.filter(function(item){
                        ...
                        if(filtered){
                            if(filterBanco && filterBanco.length > 0){
                                filtered = item.banco == filterBanco
        ...
        methods: {
            ...
            calculaTotal(){
                let amounts = this.computed_items.map(transaction => transaction.valor);
